...
- Не понял момент с "При загрузке приложения по дефолту выводятся вакансии на сегодняшний день.", тк при загрузке приложения сразу отправляем запрос на вакансии и выводим Skeleton.
